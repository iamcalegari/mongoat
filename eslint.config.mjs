...
// `.eslintrc` antigo — ESLint 9 o ignorava silenciosamente). `.mjs` evita
// qualquer necessidade de `require`/`module`/`__dirname` (o pacote não
// declara "type": "module",
...
export default tseslint.config(
  {
    ignores: [
      ...
      'docs/api/**',
      // Diretórios locais/pessoais não-versionados (config de editor, ferramentas
      // de workflow) — não são código do projeto e não devem ser lintados.
      '.obsidian/**',
      '.claude/**',
      '.planning/**',
    ],
