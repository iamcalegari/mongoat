 ...
 * Usa o plugin `vite-tsconfig-paths` e também
 ...
 * subido/derrubado pelo globalSetup abaixo — sem servidor Mongo
 * em memória.
 */
export default defineConfig({
  ...
  test: {
    ...
    testTimeout: 60000,
    // Gate de cobertura, só aplicado quando a suíte roda com `--coverage`
    // (`npm test` puro não paga o custo de instrumentação). Os thresholds
    // são um PONTO DE PARTIDA — deliberadamente abaixo de 100%, que
